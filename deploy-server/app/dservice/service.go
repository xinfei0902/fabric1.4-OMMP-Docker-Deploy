...
func RegisterWebAPI(debug bool, db bool) (err error) {
	...
	list := []httpHandleFuncPair{
        ...
        //主机
		{base + "indent/server/add", makeServerAddInfo},
		{base + "indent/server/get/ip/list", makeServerGetIPList},
		{base + "indent/server/get/allInfo", makeServerGetAllInfo},
		{base + "indent/server/modity/serverName", makeServerModityName},
		{base + "indent/server/modity/serverdes", makeServerModityDes},
		{base + "indent/server/modity/serverUserAndPassword", makeServerModityUserAndPassword},
		{base + "indent/server/delete", makeServerDelete},
		//一键部署
		{base + "indent/complete/deploy", makeIndentCompleteDeploy},
		{base + "indent/complete/delete/blockchain", makeIndentCompleteDeleteDeploy},
		//获取ip列表以及档期机器安装几个节点
		...
		//合约
        //编译 
		{base + "indent/general/create/chaincode/bulid/Upload", makeGeneralCreateChainCodeBulidUpload},
		{base + "indent/general/create/chaincode/bulid", makeGeneralCreateChainCodeBulid},
		{base + "indent/general/create/chaincode/bulid/folder/file", makeGeneralCreateChainCodeBulidFolderFile},
		{base + "indent/general/create/chaincode/bulid/get/file", makeGeneralCreateChainCodeBulidGetFile},
		//需要新增一个接受上传合约链码接口
