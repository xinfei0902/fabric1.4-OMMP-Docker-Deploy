...
//NewGeneralCompleteDeleteDeploy  一键部署
func NewGeneralCompleteDeleteDeploy() *objectdefine.TaskType {
	return objectdefine.NewTaskType(
		NewGeneralCompleteDeleteDeployStep(),
		MakeGeneralStartStep(),
		MakeGeneralEndStep())
}
...
//NewGeneralChainCodeBulid 合约编译
func NewGeneralChainCodeBulid() *objectdefine.TaskType {

	return objectdefine.NewTaskType(
		NewGeneralChainCodeBulidStep(),
		MakeGeneralStartStep(),
		MakeGeneralEndStep())
}
//NewGeneralAddServerInfo 添加主机
func NewGeneralAddServerInfo() *objectdefine.TaskType {

	return objectdefine.NewTaskType(
		NewGeneralAddServerInfoStep(),
		MakeGeneralStartStep(),
		MakeGeneralEndStep())
}