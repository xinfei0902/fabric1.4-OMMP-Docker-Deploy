...
echo "========================================="
cd ${TARGET}
COMPOSE_PROJECT_NAME=anhui docker-compose -f base.yaml up -d $PEER_NAME
sleep 3
COMPOSE_PROJECT_NAME=anhui docker-compose -f base.yaml up -d $CA_CONTINUE_NAME
sleep 3
COMPOSE_PROJECT_NAME=anhui docker-compose -f base.yaml up -d ${NEW_ORG_CLI_NAME}
sleep 3
cd -
...
do
  ...
  docker exec ${PEER_NAME} sh -c "echo ${PEER_HOST[$i]} >>/etc/hosts"
done
